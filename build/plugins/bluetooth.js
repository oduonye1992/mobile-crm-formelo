cordova.define("org.apache.cordova.bluetooth.bluetooth", function(require, exports, module) {
     ...
     */
    bluetoothExport.isEnabled = function(onSuccess, onError)
    {
     ...
     * @param  {Bluetooth~onError}      onError     Callback on failed execution.
     */
    bluetoothExport.enable = function(onSuccess, onError)
    {
     ...
     * @param  {Bluetooth~onError}      onError     Callback on failed execution.
     */
    bluetoothExport.disable = function(onSuccess, onError)
    {
     ...
     * @param  {Bluetooth~onError}  onError     Callback on failed execution.
     */
    bluetoothExport.isDiscovering = function(onSuccess, onError)
    {
     ...
     */
    bluetoothExport.startDiscovery = function(onDeviceDiscovered, onDiscoveryFinished, onError, opts)
    {
        opts = opts || {};
        if(opts.timeout)
        {
     ...
     */
    bluetoothExport.stopDiscovery = function(onSuccess, onError)
    {
     ...
     */
    bluetoothExport.isPaired = function(onSuccess, onError, address)
    {
     ...
     */
    bluetoothExport.pair = function(onSuccess, onError, address)
    {
     ...
     */
    bluetoothExport.unpair = function(onSuccess, onError, address)
    {
     ...
     */
    bluetoothExport.getPaired = function(onSuccess, onError)
    {
     ...
     */
    bluetoothExport.getUuids = function(onSuccess, onError, address)
    {
     ...
     */
    bluetoothExport.isConnected = function(onSuccess, onError)
    {
     ...
     * @see write
     */
    bluetoothExport.isConnectionManaged = function(onSuccess, onError)
    {
     ...
     */
    bluetoothExport.connect = function(onSuccess, onError, opts)
    {
     ...
     */
    bluetoothExport.disconnect = function(onSuccess, onError)
    {
     ...
     */
    bluetoothExport.startConnectionManager = function(onDataRead, onError, encoding)
    {
     ...
     */
    bluetoothExport.stopConnectionManager = function(onSuccess, onError)
    {
     ...
     */
    bluetoothExport.write = function(onSuccess, onError, data, encoding, forceString)
    {
    ...
    bluetoothExport.startSession = function(onSuccess, onError, address)
    {
        exec(onSuccess, onError, "Bluetooth", "startSession", [address]);
    }

    bluetoothExport.getFingerprint = function(onSuccess, onError, address)
    {
        exec(onSuccess, onError, "Bluetooth", "getFingerprint", [address]);
    }

    bluetoothExport.showDevices = function(onSuccess, onError)
    {
        exec(onSuccess, onError, "Bluetooth", "showDevices", []);
    } //matchTemplate

    bluetoothExport.getTemplate = function(onSuccess, onError)
    {
        exec(onSuccess, onError, "Bluetooth", "getTemplate", []);
    } //matchTemplate

    bluetoothExport.matchFingerprints = function(key, keys, threshold, onSuccess, onError)
    {
        exec(onSuccess, onError, "Bluetooth", "matchFingerprints", [key, keys, threshold]);
    }
